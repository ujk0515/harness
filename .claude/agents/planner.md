...
```
┌──────────────────────┐   ┌──────────────────────────────┐
│ wf_auth_login        │   │ desc_auth_login              │
│                      │   │ 화면 ID / 화면명 / 경로       │
│  실제 화면 구조       │   │ No / Description 테이블      │
│  390×844 모바일 기준  │   │ 구성요소 설명 / 상태 설명     │
│                      │   │                              │
└──────────────────────┘   └──────────────────────────────┘
```
...
- 상단 헤더: 화면 ID, 화면명, 화면 경로
- 본문: No + 기획 Description 테이블
- 각 No는 `wf_*` Board의 구성요소와 1:1 대응
- Description에 포함할 내용:
  - 요소 이름 + 역할
